...
public:
	...
	inline CString	GetStrId()								{ CString strID; strID.Format(CString("Body %d"), m_nID); return strID;}
	inline CString	GetStrIdName()							{ CString strID; strID.Format(CString("Body %d - "), m_nID); strID += m_strName; return strID;}
